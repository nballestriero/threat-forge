# MR-0001REQ-0015 — Governed document body orphan detection

## Intent

This requirement derives from `MR-0001/ADR-0006` and defines one small, verifiable obligation for the project-model governance substrate.

## Requirement

The project model must detect governed Markdown body files that are missing from the corresponding registry and registry records whose body path does not resolve.
