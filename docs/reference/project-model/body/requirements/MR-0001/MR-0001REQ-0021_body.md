# MR-0001REQ-0021 — Bidirectional graph-to-code traceability validation
...
The project model must validate traceability in both directions between graph records and source artifact declarations.
