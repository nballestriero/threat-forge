...
const gateCommands = [
  ...
  {
    label: "Child project governance gate plan artifacts",
    command: "npm",
    args: ["run", "docs:child-project-governance-plan-artifacts"],
  },
  {
    label: "Child project governance plan API serve self-test",
    command: "npm",
