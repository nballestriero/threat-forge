...
import { createStaticProjectDocumentationExplorerClient } from "./MR-0002/project-documentation-explorer/project-documentation-explorer.client.js";
import "./styles.css";
 ...
 * project-model registries from the browser. Local preview data is a generated
 * backend view-model snapshot consumed through the same client boundary that a
 * future HTTP adapter will replace.
 *
 ...
 */
const client = createStaticProjectDocumentationExplorerClient({
