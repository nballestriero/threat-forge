# MR-0000REQ-0004 — Standard Project Model Registry Body and Graph Structure
...
The child project must keep the standard Project Model directories, registries, governed bodies and graph records in place.
...
```gherkin
Scenario: Standard Project Model Registry Body and Graph Structure
