...
const requirementsRegistryPattern =
  "restart-workspace/docs/reference/project-model/registers/requirements/{MR}.requirements.registry.yml";
const requirementsBodyPattern =
  "restart-workspace/docs/reference/project-model/body/requirements/{MR}/{ID}_body.md";
...
function helpText() {
  return `Usage:
  node restart-workspace/tools/MR-0001/create-governed-document.mjs \\
