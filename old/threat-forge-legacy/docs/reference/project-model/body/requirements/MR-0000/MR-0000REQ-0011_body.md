# MR-0000REQ-0011 — Governed working plan artifact
...
The project must keep a governed working plan artifact as the lightweight semantic state used for project-model handoff and ongoing planning.
