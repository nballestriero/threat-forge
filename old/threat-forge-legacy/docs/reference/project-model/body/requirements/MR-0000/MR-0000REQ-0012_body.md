# MR-0000REQ-0012 — Working plan coherence rules
...
The working plan must remain coherent with ADR registries, Requirement registries, graph records, implementation artifacts, and gate status instead of becoming an independent source of truth.
