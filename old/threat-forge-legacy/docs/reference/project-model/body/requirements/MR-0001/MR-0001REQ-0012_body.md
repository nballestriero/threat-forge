# MR-0001REQ-0012 — Canonical ADR identity resolution
...
The project model must resolve ADR identity using macro-requirement context plus local ADR id, not the local ADR id alone.
