# MR-0001REQ-0014 — Canonical Requirement registry and body format validation
...
The project model must validate Requirement registry records and Requirement Markdown bodies against the governed requirement format rules.
