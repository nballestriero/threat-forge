# MR-0001REQ-0018 — GraphRAG traversal rules for project exploration

## Intent

This requirement derives from `MR-0001/ADR-0007` and defines one small, verifiable obligation for the project-model governance substrate.

## Requirement

The project model must define traversal rules that allow humans and LLMs to explore the project through graph-grounded paths instead of inferred relationships.
