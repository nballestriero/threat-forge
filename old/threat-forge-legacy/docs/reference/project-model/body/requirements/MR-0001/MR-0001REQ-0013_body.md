# MR-0001REQ-0013 — Project model ID collision detection

## Intent

This requirement derives from `MR-0001/ADR-0005` and defines one small, verifiable obligation for the project-model governance substrate.

## Requirement

The project model must detect invalid ID collisions according to the canonical identity rules for macro requirements, ADRs, requirements, graph nodes, and implementation artifacts.
