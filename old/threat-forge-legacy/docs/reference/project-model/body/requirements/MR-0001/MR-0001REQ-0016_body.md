# MR-0001REQ-0016 — Governed graph view profiles
...
The project model must support declared graph view profiles as derived projections over the canonical knowledge graph.
